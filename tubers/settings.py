...
CSRF_TRUSTED_ORIGINS = ['http://ytubers-production.up.railway.app:800']
ALLOWED_HOSTS = ['ytubers-production.up.railway.app']
CORS_ORIGIN_WHITELIST = ['http://ytubers-production.up.railway.app:800']
...
INSTALLED_APPS = [
    'contactTeam.apps.ContactteamConfig',
